 ...
 * [hcao.yml](hcao.yml)
     * Determines how your purl.obolibrary.org/obo/hcao/ redirects will be handled
     ...
     * Paste in the contents of [hcao.yml](hcao.yml)
 ...
 * [hcao.md](hcao.md)
     ...
     * Paste in the contents of [hcao.md](hcao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
